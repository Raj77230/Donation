...
<h3>Enter Your Payments Details...</h3>
</div>
<br>
<br>
<br>
<div class="detail">
<form action="thanks.php" method="get/post">
<input type="text" name="cardnumber" placeholder="Enter your CardNumber..">
<input type="text" name="amounts" placeholder="Enter your Amount..">
...
$to=$_POST['Email'];
$phone=$_POST['Mobile'];
$email='saksham7723045348@gmail.com';
